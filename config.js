...
sites:{
  "domaene01" : {id: "domaene01",short:"d01",name:"Münster Stadt", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  ...
  "domaene05" : {id: "domaene05",short:"d05",name:"Münster Süd", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  //"domaene06" : {id: "domaene06",short:"d06",name:"Westmünsterland", version:"2.1.0", version_base:"2016.2.1", on_map: false },
  "domaene07" : {id: "domaene07",short:"d07",name:"Telgte", version:"2.1.3", version_base:"2016.2.1", on_map: true },
  "domaene08" : {id: "domaene08",short:"d08",name:"Gescher", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene09" : {id: "domaene09",short:"d09",name:"Stadtlohn", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  // "domaene10" : {id: "domaene10",short:"d10",name:"Testdomäne", version:"2.1.0", version_base:"2016.2.1", on_map: false },
  "domaene11" : {id: "domaene11",short:"d11",name:"Bocholt", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene12" : {id: "domaene12",short:"d12",name:"Dülmen (ohne Rorup)", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene13" : {id: "domaene13",short:"d13",name:"Rorup", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene14" : {id: "domaene14",short:"d14",name:"Dingden", version:"2.1.0", version_base:"2016.1.6", on_map: true },
  "domaene15" : {id: "domaene15",short:"d15",name:"Heek", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene16" : {id: "domaene16",short:"d16",name:"Münster Promenade", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene17" : {id: "domaene17",short:"d17",name:"Emsdetten", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene18" : {id: "domaene18",short:"d18",name:"Greven", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene19" : {id: "domaene19",short:"d19",name:"Neuenkirchen", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene20" : {id: "domaene20",short:"d20",name:"Ochtrup", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene21" : {id: "domaene21",short:"d21",name:"Rheine", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene22" : {id: "domaene22",short:"d22",name:"Steinfurt", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene23" : {id: "domaene23",short:"d23",name:"Metelen", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene24" : {id: "domaene24",short:"d24",name:"Wettringen", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene25" : {id: "domaene25",short:"d25",name:"Steinfurt-Ost", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene26" : {id: "domaene26",short:"d26",name:"Borken", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene27" : {id: "domaene27",short:"d27",name:"Selm", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene28" : {id: "domaene28",short:"d28",name:"Horstmar", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene29" : {id: "domaene29",short:"d29",name:"Laer", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene30" : {id: "domaene30",short:"d30",name:"Nordwalde", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene31" : {id: "domaene31",short:"d31",name:"Altenberge", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene32" : {id: "domaene32",short:"d32",name:"Ahlen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene33" : {id: "domaene33",short:"d33",name:"Beckum", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene34" : {id: "domaene34",short:"d34",name:"Beelen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene35" : {id: "domaene35",short:"d35",name:"Drensteinfurt", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene36" : {id: "domaene36",short:"d36",name:"Ennigerloh", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene37" : {id: "domaene37",short:"d37",name:"Everswinkel", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene38" : {id: "domaene38",short:"d38",name:"Oelde", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene39" : {id: "domaene39",short:"d39",name:"Ostbevern", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene40" : {id: "domaene40",short:"d40",name:"Sassenberg", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene41" : {id: "domaene41",short:"d41",name:"Sendenhorst", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene42" : {id: "domaene42",short:"d42",name:"Wadersloh", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene43" : {id: "domaene43",short:"d43",name:"Warendorf", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene44" : {id: "domaene44",short:"d44",name:"Ascheberg", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene45" : {id: "domaene45",short:"d45",name:"Billerbeck", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene46" : {id: "domaene46",short:"d46",name:"Coesfeld", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene47" : {id: "domaene47",short:"d47",name:"Havixbeck", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene48" : {id: "domaene48",short:"d48",name:"Lüdinghausen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene49" : {id: "domaene49",short:"d49",name:"Nordkirchen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene50" : {id: "domaene50",short:"d50",name:"Nottuln", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene51" : {id: "domaene51",short:"d51",name:"Olfen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene52" : {id: "domaene52",short:"d52",name:"Rosendahl", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene53" : {id: "domaene53",short:"d53",name:"Senden", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene54" : {id: "domaene54",short:"d54",name:"Ahaus", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene55" : {id: "domaene55",short:"d55",name:"Heiden", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene56" : {id: "domaene56",short:"d56",name:"Isselburg", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene57" : {id: "domaene57",short:"d57",name:"Legden", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene58" : {id: "domaene58",short:"d58",name:"Reken", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene59" : {id: "domaene59",short:"d59",name:"Rhede", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene60" : {id: "domaene60",short:"d60",name:"Schöppingen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
...
routers: {
 ...
 "gl-ar150": { id: "gl-ar150", name: "GL-AR150", manufacturer: "GL Innovations" },
